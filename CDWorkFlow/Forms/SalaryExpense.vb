Public Class SalaryExpense
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Expense_Tracker.ExpenseView.Item(columnIndex:=2, rowIndex:=totRow).Value = to_date.Text
        Dim _val As Decimal = Convert.ToDecimal(txtAmount.Text).ToString("#,##0.0")
        Expense_Tracker.ExpenseView.Item(columnIndex:=3, rowIndex:=totRow).Value = _val
        totRow += 1
    End Sub
